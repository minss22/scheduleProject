...
## 📑 API 명세서
| Index | 기능     | Method   | URL             | Parameters |  Request Body                                                                     | Response Body                                                                                                                                     | 상세 설명                    |
|-------|--------| -------- | --------------- |------------|-----------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|
| **1** | 일정 생성  | **POST** | `/schedules`  | -          | `json { "title": "공부", "content": "스프링 부트 공부", "name": "홍길동", "password": 1234 }` | `json { "id": 1, "title": "공부", "content": "스프링 부트 공부", "name": "홍길동", "createdAt": "2025-11-05T10:00:00", "modifiedAt": "2025-11-05T10:00:00" }` | 신규 일정 등록                 |
| **2** | 전체 일정 조회 | **GET**  | `/schedules` | (Query) name | -                                                                                 | `json [ { "id": 1, "title": "공부", "content": "스프링 부트 공부", "name": "홍길동", "createdAt": "2025-11-05T10:00:00", "modifiedAt": "2025-11-05T10:00:00" } ]` | `name` 입력 시 작성자명으로 조회 |
| **3** | 일정 단건 조회 | **GET**  | `/schedules/{id}` | (Path) id  | -                                                                                 | `json { "id": 1, "title": "공부", "content": "스프링 부트 공부", "name": "홍길동", "createdAt": "2025-11-05T10:00:00", "modifiedAt": "2025-11-05T10:00:00" }` | 특정 일정 1건 조회              |
| **4** | 일정 수정  | **PUT**  | `/schedules/{id}` | (Path) id  | `json { "title": "공부", "name": "홍길동", "password": 1234 }`                         | `json { "id": 1, "title": "공부", "content": "스프링 부트 공부", "name": "홍길동", "createdAt": "2025-11-05T10:00:00", "modifiedAt": "2025-11-05T11:00:00" }` | 비밀번호 검증 필요               |
| **5** | 일정 삭제  | **DELETE** | `/schedules/{id}` | (Path) id  | `json { "password": 1234 }`                                                       | -                                                                                                                                                 | 비밀번호 검증 필요               |
